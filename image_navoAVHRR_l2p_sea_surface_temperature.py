...
#  print(year, month, day, hh, mm, ss, w) 
   solarzen=np.reshape(w, (-1, np.shape(lats)[1]))
...
ax.set_title("NAVO AVHRR Metop-B L2P SST for {}-{}-{} ({})".format(fn[:4], fn[4:6], fn[6:8], fn[:14]), position=(0.5, 1.1),\
		fontsize=12)
